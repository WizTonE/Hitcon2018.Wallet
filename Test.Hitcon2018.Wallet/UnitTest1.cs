...
namespace Test.Hitcon2018.Wallet
{
    [TestClass]
    public class UnitTest1
    {
        ...
        public async void TestMethod1Async()
        {
            ...
            var eth = new EthService(new Web3(account, @"http://api-ropsten.etherscan.io"));
            
            //Test();
            var balance = await eth.GetBalance("0xFbF065C72Ad57611d26DCcd5041806fB5A988D92");
            Console.WriteLine("the balance is :" + balance);
            Assert.IsTrue(balance > 0);
        }
        public static class AccountFactory
        {
            public static string PrivateKey = "768737baf760264de8b8f9352ed135af8b7f69b9a6158ff616a00d81e03ab71a";
            public static string Address = "0xFbF065C72Ad57611d26DCcd5041806fB5A988D92";
            public static string Password = "700508aA1";
        ...
        public async void Test()
        {
            ...
            var web3 = new Web3(@"http://api-ropsten.etherscan.io");
            try
            {
                var eth = web3.Eth;
                ...
                Assert.Equals(totalSupply, totalSupplyDeployed);

                var ownerBalance = await tokenService.GetBalanceOfAsync<ulong>(addressOwner);
                Assert.Equals(totalSupply, ownerBalance);
                ...
                Assert.Equals(totalSupply - 1000, ownerBalance);

                var newAddressBalance = await tokenService.GetBalanceOfAsync<ulong>(newAddress);
                Assert.Equals((ulong)1000, newAddressBalance);
                ...
                //Assert.Equals(transferLog.Log.TransactionIndex.HexValue, transferReceipt.TransactionIndex.HexValue);
                //Assert.Equals(transferLog.Log.BlockNumber.HexValue, transferReceipt.BlockNumber.HexValue);
                //Assert.Equals(transferLog.Event.AddressTo.ToLower(), newAddress.ToLower());
                //Assert.Equals(transferLog.Event.Value, (ulong)1000);
            }
            finally
            {
